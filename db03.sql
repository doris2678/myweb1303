...
INSERT INTO `movies` (`id`, `name`, `level`, `length`, `ondate`, `publish`, `director`, `trailer`, `poster`, `intro`, `rank`, `sh`) VALUES
...
INSERT INTO `orders` (`id`, `no`, `movie`, `date`, `session`, `tickets`, `seats`) VALUES
