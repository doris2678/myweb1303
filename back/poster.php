<div style="height:300px;">
    ...
    <form action="./api/edit_poster.php" method="post">
        <div style="overflow:auto;height:200px;">
            ...
            ?>
            <div class="ct"
                style="padding:3px;display:flex;justify-content:space-between;align-items:center;background:white;margin-bottom:3px;">
                ...
                <div style="width:24.8%;">
                    <input type="checkbox" name="sh[]" value="<?=$poster['id'];?>"
